 ...
 * author : GGG
 * date : 2023-10-05
 * description : @RequestMapping, @RequsetParam
 * 요약 :
 * <p>
 * ===========================================================
 * DATE            AUTHOR             NOTE
 ...
 */
@Controller
// TODO: @RequsetMapping ("/공통url") : 공통 url과 함수의 url이 합쳐져서 사용됨 
...
//             옵션 : defaultValue="대체값" : 쿼리스트링 변수에 값이 null이면 "대체값" 바꿔줌
...
//        url 테스트 : http://localhost:8000/exam02/hello-no?no=20
    ...
    public String HelloNo(Model model
        ...
        model.addAttribute("greeting", "결과 : "+ no);
