 ...
 * author : GGG
 * date : 2023-10-05
 * description : @PathVaribale : 파라메터 방식 매개변수 전달하는 어노테이션
 * 요약 :
 * <p>
 * ===========================================================
 * DATE            AUTHOR             NOTE
...
// TODO: url 테스트 : http://localhost:8000/exam05/path-variable/Mayogiya
//      => 파라메터 방식 : @GetMapping("/path-variable/{웹매개변수명}")
//      => 웹브라우저 주소창 사용 : url/값
// TODO: 쿼리스트링 : http://localhost:8000/exam05/path-variable?name=/Mayogiya
