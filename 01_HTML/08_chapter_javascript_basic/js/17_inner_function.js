...
// 사용법 : 변수명.toFixed(자리수)
// let x = 12.4763;
// console.log(x.toFixed(2)); // 둘째 자리수 자르기
...
// TODO: 4) 배열의 길이(갯수) : 배열변수.length(반복문에 많이 사용)
// let animals =["사자", "호랑이", "사슴", "펭귄"];
...
// console.log("str.substring",str.substring(4,8)); //4,5,6,7까지 보임 


// TODO: 7) 문자열 바꾸기 함수
// 사용법 : 문자열.replace(/대상문자/g, "바꿀문자");
// let str = "A friend in nedd is a friend indeed";
