...
-- 뷰 정보 확인 : 데이터 사전(시스템테이블:관리용(미리생성되어있음) : USER_VIEWS                          
SELECT * FROM USER_VIEWS;

-- 뷰에 INSERT 가능한가? 
-- 예제2) VW_EMP_JOB에 INSERT 하기
...
VALUES(30, 1000, 3000); -- 에러 

-- 뷰 삭제 (DROP ~)
-- 사용법) DROP VIEW 뷰이름;
DROP VIEW VW_EMP_SALARY;

-- (참고) 뷰에 INSERT 기본 기능 (그룹함수 없을 때) 
-- 뷰에 INSERT 기능 제한 : 옵션 추가 :WIRH READ ONLY
-- 예제 4) WIRH READ ONLY 옵션을 붙여서 뷰 만들기
--  SQL : 직위가 MANAGER인 사원을 출력하는 뷰 만들기 
