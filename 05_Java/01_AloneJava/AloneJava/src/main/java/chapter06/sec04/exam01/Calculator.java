...
/**
 * packageName : chapter06.sec04.exam01
 * fileName : Calculator
 * author : GGG
 * date : 2023-09-20
 * description : 모델 클래스
 ...
 *             접근 제어자 : public(공용), default(생략, package 내에서는 사용 가능 ) 등
 *             함수이름 명명법 : 낙타표기법(카멜표기법), 첫글자는 소문자, 단어 + 단어는 대문자
 *             매개변수 : 함수 실행 시 전달되는 데이터
 *             리턴자료형 : 함수가 실행된 이후  결과값을 내보내기 할 때 사용
 *             리턴값이 없는 함수 형태 호출 : 객체 변수, 함수()
 *             리턴값이 있는 함수 형태 호출 : double result = 객체 변수, 함수()
 *
 * <p>
 * ===========================================================
 * DATE            AUTHOR             NOTE
