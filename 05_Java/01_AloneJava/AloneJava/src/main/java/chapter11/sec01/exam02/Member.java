...
/**
 * packageName : chapter11.sec01.exam02
 * fileName : Member
 * author : GGG
 * date : 2023-09-25
 ...
 *        2) HashMap, HashSet 자료 구조에서 내부적으로 해쉬코드를 사용함(객체들을 비교할 때)
 *      TODO:  => 기본 HashCode는 객체 간 비교에서 오류를 일으키므로 재정의해야 함
 *      => 결론) .equals(), hashCode() 재정의해야함 (추천 : 자동 코딩 기능 이용)0
 * <p>
 * ===========================================================
 * DATE            AUTHOR             NOTE
 * —————————————————————————————
