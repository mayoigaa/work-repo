...
/**
 * packageName : etc
 * fileName : RandomApplication
 * author : GGG
 * date : 2023-10-02
 * description : 람다식(js:화살표함수) : 1)함수형 인터페이스 사용
 *                                    2) 익명 객체에서 사용
 * 요약 :
 * <p>
 * ===========================================================
...
//        Consumer(소비자) 함수 : 매개변수(o), 리턴값(x) 함수 예) void accept()
//        Function(일반) 함수 : 매개변수(o), 리턴값(o) 함수 예) int apply(int t)
//        Predicate(논리(명제)) 함수 : 매개변수(o), 리턴값(o, 참/),
//                                                      함수 예) boolean apply(int t)


        Supplier<Integer> s = () -> (int)(Math.random()*100) + 1; // 1 ~ 100까지 랜덤 수
